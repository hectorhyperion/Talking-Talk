...
<!-- Template JavaScript -->
<script src="<?php echo base_url('set/js/jquery-3.3.1.min.js')?> "></script>

<!-- theme changer js -->
<script src=" <?php echo base_url('set/js/theme-change.js')?>"></script>
<!-- //theme changer js -->

<!-- courses owlcarousel -->
<script src="<?php echo base_url('set/js/owl.carousel.js')?>"></script>
