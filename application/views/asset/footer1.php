  ...
  <script src="<?php echo site_url('assets/js/bar.js')?>"></script>
  <script src="<?php echo site_url('assets/js/linechart.js')?>"></script>
  <!-- //Different scripts of charts.  Ex.Barchart, Linechart -->
  
  
  <script src="<?php echo site_url('assets/js/jquery.nicescroll.')?>'"></script>
